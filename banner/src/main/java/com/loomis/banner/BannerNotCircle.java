...
public class BannerNotCircle extends FrameLayout implements OnPageChangeListener {
    ...
    public BannerNotCircle(Context context) {
        this(context, null);
    }

    public BannerNotCircle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BannerNotCircle(Context context, AttributeSet attrs, int defStyle) {
    ...
    public BannerNotCircle isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BannerNotCircle setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BannerNotCircle setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BannerNotCircle setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BannerNotCircle setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BannerNotCircle setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BannerNotCircle setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BannerNotCircle setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BannerNotCircle setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BannerNotCircle setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BannerNotCircle setImages(List<?> imageUrls) {
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        initImages();
        addImageViews(imagesUrl);
    }

    /**
     * 非循环滑动viewpager所需要的imageview
     *
     * @param imagesUrl
     */
...
//        photoView.setScale(1.0f);
    ...
    @Deprecated
    public BannerNotCircle setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public BannerNotCircle setOnBannerListener(OnBannerListener listener) {
     ...
     * @param position
     */
    public BannerNotCircle setCurPosition(int position) {
